...
file8 ='summary_11_2_0/PAT_SUM_CMSSW_11_2_0_pre8.txt'
file9 ='summary_11_2_0/PAT_SUM_CMSSW_11_2_0_pre9.txt'
file10 ='summary_11_2_0/PAT_SUM_CMSSW_11_2_0_pre10.txt'
file11 ='summary_11_2_0/PAT_SUM_CMSSW_11_2_0_pre11.txt'
file12 ='summary_11_2_0/PAT_SUM_CMSSW_11_2_0.txt'
'''

file1 ='summary_11_2_0/PAT_SUM_CMSSW_11_2_0.txt'
file2 ='summary_11_3_0/PAT_SUM_CMSSW_11_3_0_pre1.txt'
file3 ='summary_11_3_0/PAT_SUM_CMSSW_11_3_0_pre2.txt'
...
axs[0,0].plot(evt_list,RSS_list,'-o',color='r')
axs[0,0].plot(evt_list2,RSS_list2,'-o',color='g')
axs[0,0].plot(evt_list3,RSS_list3,'-o',color='b')
...
axs[0,1].plot(evt_list3,VSIZE_list3,'-o',color='b')
...
axs[0,1].legend(['CMSSW_11_2_0','CMSSW_11_3_0_pre1','CMSSW_11_3_0_pre3'],prop={'size' :20})
axs[0,1].grid()
...
axs[1,1].hist(VSIZE_list,bins=bins,color='r',histtype='step',linewidth=3)
axs[1,1].hist(VSIZE_list2,bins=bins,color='g',histtype='step',linewidth=3)
axs[1,1].hist(VSIZE_list3,bins=bins,color='b',histtype='step',linewidth=3)
...
## Time
bins = numpy.linspace(0,80,100)
axs[1,2].hist(time_list,bins=bins,color='r',histtype='step',linewidth=3)
axs[1,2].hist(time_list2,bins=bins,color='g',histtype='step',linewidth=3)
axs[1,2].hist(time_list3,bins=bins,color='b',histtype='step',linewidth=3)
