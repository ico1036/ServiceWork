...
file8 ='summary_11_2_0/SUM_CMSSW_11_2_0_pre8.txt'
file9 ='summary_11_2_0/SUM_CMSSW_11_2_0_pre9.txt'
file10 ='summary_11_2_0/SUM_CMSSW_11_2_0_pre10.txt'
file11 ='summary_11_2_0/SUM_CMSSW_11_2_0_pre11.txt'
file12 ='summary_11_2_0/SUM_CMSSW_11_2_0.txt'
'''

file1 ='summary_11_2_0/SUM_CMSSW_11_2_0.txt'
file2 ='summary_11_3_0/SUM_CMSSW_11_3_0_pre1.txt'
file3 ='summary_11_3_0/SUM_CMSSW_11_3_0_pre2.txt'
...
axs[0,0].plot(evt_list2,RSS_list2,'-o',color='g',alpha=0.7)
axs[0,0].plot(evt_list3,RSS_list3,'-o',color='b',alpha=0.7)
...
axs[0,0].set_ylim([3000,5000])
axs[0,0].set_xlabel('ith event',fontsize=25)
axs[0,0].set_ylabel('Memory(MB)',fontsize=25)

axs[0,0].legend(['CMSSW_11_2_0','CMSSW_11_3_0_pre1','CMSSW_11_3_0_pre2'],prop={'size' :20})
axs[0,0].grid()

## Vsize
axs[0,1].plot(evt_list,VSIZE_list,'-o',color='r',alpha=0.7)
axs[0,1].plot(evt_list2,VSIZE_list2,'-o',color='g',alpha=0.7)
axs[0,1].plot(evt_list3,VSIZE_list3,'-o',color='b',alpha=0.7)
...
axs[0,1].set_ylim([4000,14000])
axs[0,1].set_xlabel('ith event',fontsize=25)
axs[0,1].set_ylabel('Memory(MB)',fontsize=25)

axs[0,1].legend(['CMSSW_11_2_0','CMSSW_11_3_0_pre1','CMSSW_11_3_0_pre2'],prop={'size' :20})
axs[0,1].grid()

# Time
axs[0,2].plot(evt_list,time_list,'-o',color='r')
axs[0,2].plot(evt_list2,time_list2,'-o',color='g')
...
axs[0,2].set_ylim([0,401])
#axs[0,2].set_ylim([0,400])
#axs[0,2].set_yscale('log')
axs[0,2].set_xlabel('ith event',fontsize=25)
axs[0,2].set_ylabel('time (seconds)',fontsize=25)

axs[0,2].legend(['CMSSW_11_2_0','CMSSW_11_3_0_pre1','CMSSW_11_3_0_pre2'],prop={'size' :20})
axs[0,2].grid()


## RSS
bins = numpy.linspace(3000,6000,50)
...
axs[1,0].hist(RSS_list3,bins=bins,color='b',histtype="step",linewidth=3)
...
## Vsize
bins = numpy.linspace(4000,14000,50)
...
axs[1,1].hist(VSIZE_list3,bins=bins,color='b',alpha=0.9,histtype="step",linewidth=3)
