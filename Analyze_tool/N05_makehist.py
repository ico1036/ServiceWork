...
file1 ='summary_11_2_0/SUM_CMSSW_11_2_0_pre1.txt'
file2 ='summary_11_2_0/SUM_CMSSW_11_2_0_pre2.txt'
file3 ='summary_11_2_0/SUM_CMSSW_11_2_0_pre3.txt'
file4 ='summary_11_2_0/SUM_CMSSW_11_2_0_pre4.txt'
file5 ='summary_11_2_0/SUM_CMSSW_11_2_0_pre5.txt'
file6 ='summary_11_2_0/SUM_CMSSW_11_2_0_pre6.txt'
file7 ='summary_11_2_0/SUM_CMSSW_11_2_0_pre7.txt'
...
axs[0,0].plot(evt_list4,RSS_list4,'-o',color='blue')
...
axs[0,0].legend(['CMSSW_11_2_0_pre1','CMSSW_11_2_0_pre2','CMSSW_11_2_0_pre4','CMSSW_11_2_0_pre6'],prop={'size' :20})
...
axs[0,1].plot(evt_list4,VSIZE_list4,'-o',color='blue')
...
axs[0,1].legend(['CMSSW_11_2_0_pre1','CMSSW_11_2_0_pre2','CMSSW_11_2_0_pre4','CMSSW_11_2_0_pre6'],prop={'size' :20})
axs[0,1].grid()

# Time
axs[0,2].plot(evt_list,time_list,'-o',color='r',alpha=0.7)
axs[0,2].plot(evt_list2,time_list2,'-o',color='green')
axs[0,2].plot(evt_list3,time_list3,'-o',color='b')
axs[0,2].plot(evt_list4,time_list4,'-o',color='orange')
...
## RSS
bins = numpy.linspace(3000,8000,50)
axs[1,0].hist(RSS_list,bins=bins,color='r',histtype="step",linewidth=3)
axs[1,0].hist(RSS_list2,bins=bins,color='g',histtype="step",linewidth=3)
axs[1,0].hist(RSS_list4,bins=bins,color='b',histtype="step",linewidth=3)
...
## Vsize
bins = numpy.linspace(4000,12000,50)
axs[1,1].get_xaxis().get_major_formatter().set_useOffset(False)
axs[1,1].hist(VSIZE_list,bins=bins,color='r',alpha=0.9,histtype="step",linewidth=3)
axs[1,1].hist(VSIZE_list2,bins=bins,color='g',alpha=0.9,histtype="step",linewidth=3)
axs[1,1].hist(VSIZE_list4,bins=bins,color='b',alpha=0.9,histtype="step",linewidth=3)
axs[1,1].hist(VSIZE_list6,bins=bins,color='orange',alpha=0.9,histtype="step",linewidth=3)
#axs[1,1].hist(VSIZE_list5,bins=bins,color='r',alpha=0.9,histtype="step",linewidth=3)
#axs[1,1].hist(VSIZE_list6,bins=bins,color='g',alpha=0.9,histtype="step",linewidth=3)
...
## Time
bins = numpy.linspace(0,1100,100)
axs[1,2].hist(time_list,bins=bins,color='r',alpha=0.9,histtype="step",linewidth=3)
axs[1,2].hist(time_list2,bins=bins,color='g',alpha=0.9,histtype="step",linewidth=3)
axs[1,2].hist(time_list3,bins=bins,color='b',alpha=0.9,histtype="step",linewidth=3)
axs[1,2].hist(time_list4,bins=bins,color='orange',alpha=0.9,histtype="step",linewidth=3)
#axs[1,2].hist(time_list5,bins=bins,color='r',alpha=0.9,histtype="step",linewidth=3)
#axs[1,2].hist(time_list6,bins=bins,color='g',alpha=0.9,histtype="step",linewidth=3)
