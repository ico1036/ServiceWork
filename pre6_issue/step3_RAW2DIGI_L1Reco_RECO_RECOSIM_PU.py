...
# with command line options: step3 --conditions auto:phase2_realistic_T14 --pileup_input das:/RelValMinBias_14TeV/CMSSW_10_6_0_patch2-106X_upgrade2023_realistic_v3_2023D41noPU-v1/GEN-SIM -n 100 --era Phase2C8 --eventcontent AODSIM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,RECOSIM --datatier AODSIM --pileup AVE_200_BX_25ns --geometry Extended2026D41 --customise=Validation/Performance/TimeMemoryInfo.py --customise HLTrigger/Timer/FastTimer.customise_timer_service_singlejob --filein file:step2.root --fileout file:step3.root
...
process.FastTimerService.jsonFileName = cms.untracked.string('resources_RECO_11_1_0_pre6.json')
